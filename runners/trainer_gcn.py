...
from model.models.model_gcn import BFeatNaiveGCNNet
...
class BFeatTripletGCNTrainer(BaseTrainer):
    def __init__(self, config, device):
        super().__init__(config, device)
        
        # Model Definitions
        self.m_config = config.model
        self.model = BFeatNaiveGCNNet(
            self.config, 
            self.num_obj_class, 
            self.num_rel_class, 
            device
    ...
    def train(self):
        ...
        for e in range(self.t_config.epoch):
            ...
            for idx, (
                ...
                edge_feats, obj_pred, rel_pred = self.model(obj_pts, rel_pts, edge_indices.t().contiguous(), descriptor)
    ...
    def evaluate_validation(self):
        ...
        with torch.no_grad():
            ...
            for i, (
                ...
                _, obj_pred, rel_pred = self.model(obj_pts, rel_pts, edge_indices.t().contiguous(), descriptor)
